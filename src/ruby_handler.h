/**
 * This file is part of VXPRPG Player.
 *
...
#ifndef VXPRPG_PLAYER_RUBY_HANDLER_H
#define VXPRPG_PLAYER_RUBY_HANDLER_H

namespace RubyHandler {
	void Init();
};

#endif //VXPRPG_PLAYER_RUBY_HANDLER_H
